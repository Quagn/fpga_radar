...
HD_PWD='F:/DuAnCaNhan/fpga/hello_world/hello_world.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myPSdesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myPSdesign_wrapper.tcl -notrace
