...
HD_PWD='F:/DuAnCaNhan/fpga/hello_world/hello_world.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myPSdesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myPSdesign_wrapper.tcl
