...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/ec67/hdl" +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/ec67/hdl" +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/ec67/hdl" +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/ec67/hdl" +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/ec67/hdl" +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.myPSdesign xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.myPSdesign -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log myPSdesign_sc.so .tmp_log xcelium_lib waves.shm c.obj)
