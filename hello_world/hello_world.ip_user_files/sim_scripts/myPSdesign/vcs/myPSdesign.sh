...
#
# Script generated by Vivado on Sat Nov 09 10:44:25 +0700 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : myPSdesign.sh
...
#
# Usage        : myPSdesign.sh
#                myPSdesign.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                myPSdesign.sh [-reset_run]
#                myPSdesign.sh [-reset_log]
#                myPSdesign.sh [-help]
#
...
#                script (type 'myPSdesign.sh -help' for more information).
#
...
# script info
echo -e "myPSdesign.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./myPSdesign.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/ec67/hdl" +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/ec67/hdl" +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/ec67/hdl" +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/ec67/hdl" +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/ec67/hdl" +incdir+"../../../../hello_world.gen/sources_1/bd/myPSdesign/ipshared/b28c/hdl" +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.myPSdesign xil_defaultlib.glbl -o myPSdesign_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./myPSdesign_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key myPSdesign_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc myPSdesign_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./myPSdesign.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: myPSdesign.sh [-help]\n\
Usage: myPSdesign.sh [-step]\n\
Usage: myPSdesign.sh [-lib_map_path]\n\
Usage: myPSdesign.sh [-reset_run]\n\
Usage: myPSdesign.sh [-reset_log]\n\
Usage: myPSdesign.sh [-keep_index]\n\
Usage: myPSdesign.sh [-noclean_files]\n\n\
